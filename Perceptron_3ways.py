# Detailed Perceptron conception in Python
...
class NeuralNetwork():
    ...
    # Perceptron's input and output calculation
    def think(self,neuron_inputs):
        
        # Calling the function the calculate the inputs sum
        sum_of_weighted_inputs=self.__sum_of_weighted_inputs(neuron_inputs)
        # Calling the function to calculate the output (using sigmoid)
    ...
    # Sum (sigma) of the inputs : multiplication of each input by its weight
